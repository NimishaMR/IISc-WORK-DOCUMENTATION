...
df=pd.read_csv('/home/zenlab/Documents/MicroC_programs/nimisha_tests/switch2/timeproperwithcoreisolationfor30minssw2.csv',header=None,names=['systemtime'],)
...
print(df)
df.plot.scatter(x="Time",y="differencebwsuccesivecorrect",ylim=(1.0000000,1.0125000))
plt.show()